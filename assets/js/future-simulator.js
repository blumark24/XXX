...
<div id="fs-scr-result" class="fs-screen">
  ...
  <div class="fs-diag-block fs-diag-market">
    <div class="fs-diag-label">تشخيص السوق السعودي</div>
    <p class="fs-diag-text">في السوق السعودي، العميل يتخذ قراره بسرعة عبر واتساب، Google Maps، والمنصات الاجتماعية. أي تأخر في الرد، ضعف متابعة، أو غياب وضوح الأسعار والخدمات قد يحوّل الاستفسار إلى فرصة ضائعة خلال دقائق.</p>
  </div>
  ...
  <div class="fs-diag-block fs-diag-exec">
    <div class="fs-diag-label">القرار التنفيذي</div>
    <p class="fs-diag-text">الأولوية ليست زيادة الإعلانات الآن، بل إغلاق نقطة التسرب الحالية قبل ضخ عملاء جدد.</p>
  </div>

  <!-- ── Recommendation ── -->
  <div class="fs-diag-block fs-diag-rec">
    <div class="fs-diag-label">التوصية</div>
    <p class="fs-diag-text">نوصي بتفعيل WhatsApp AI وربطه برحلة العميل، مع تنظيم الردود، المتابعة، والحجوزات داخل نظام واحد.</p>
  </div>
  ...
  const CITY_CONTEXT = {
    'مكة':             'مكة المكرمة سوق موسمي عالي الكثافة. وقت الذروة خلال المواسم الدينية يضاعف الطلب بشكل مفاجئ، ما يجعل الاستجابة السريعة والأتمتة ضرورة وليست خياراً.',
    'جدة':             'جدة سوق تنافسي متنوع. العميل يقارن بين خيارات متعددة قبل القرار، وأي تأخر في الرد أو غياب وضوح الأسعار يدفعه للمنافس مباشرة.',
    'الرياض':          'الرياض أكبر سوق استهلاكي في المملكة. حجم الطلب مرتفع والمنافسة شديدة، والمشاريع التي تعتمد الأتمتة تنمو أسرع بكثير من تلك التي تعتمد على الجهد اليدوي.',
    'المدينة':         'المدينة المنورة سوق ذو طابع خاص بالزوار والمقيمين. الثقة والسرعة في الاستجابة عاملان محوريان في بناء قاعدة عملاء مستدامة.',
    'الدمام / الخبر':  'المنطقة الشرقية سوق متنامٍ بقطاعات خدمية واسعة. العملاء يتوقعون ردوداً سريعة وتجربة منظمة تعكس احترافية المشروع.',
  };
  ...
  function buildResult() {
    ...
    const cityLabel  = city   ? `المدينة (${city})`    : 'موقع المشروع';
    const volLabel   = volume ? `حجم التواصل (${volume} يومياً)` : 'حجم التواصل';
    const dropLabel  = dropoff ? `نقطة ضياع العميل عند: ${dropoff}` : 'نقطة ضياع العميل';
    $('fs-diag-main').innerHTML = `
      <div class="fs-diag-label">التشخيص الرئيسي</div>
      <p class="fs-diag-text">بناءً على نمط نشاط <strong>${sec}</strong>، ${cityLabel}، ${volLabel}، و${dropLabel}، يظهر أن المشروع لا يعاني فقط من ضعف نمو، بل من تسرب تشغيلي داخل رحلة العميل.</p>`;
